...
show_vless_config() {
    ...
    echo -e " Path WS             : multipath (${vless_ws_path} or /)"
    ...
    echo -e " vless://${uuid}@${addr}:8443?path=%2F&security=tls&encryption=none&type=ws&sni=${domain}#${username}"
    echo -e "${CYAN}═════════════════════════════════════════${NC}"
    echo -e " ${BOLD}LINK VLESS WS NTLS :${NC}"
    echo -e " vless://${uuid}@${addr}:80?path=%2F&encryption=none&type=ws&host=${domain}#${username}"
    echo -e "${CYAN}═════════════════════════════════════════${NC}"
